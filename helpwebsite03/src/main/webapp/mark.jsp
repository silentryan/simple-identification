...
<div class="layui-body p-body">
    ...
    <div class="pb-work">
        <div class="pbw-header">
            <ul class="pbw-nav">
                ...
                <li  class="">
                    ...
                    <button type="button" name="button">审核材料</button>
                </li>

                <li  class="">
                    <img src="/images/back/student.png" alt="">
                    <button type="button" name="button">审核结果</button>
                </li>
            </ul>
        ...
        <div id="pbw-main" class="pbw-show">
          <span class="pbwm-data">
            <button type="button" name="button">
              <img src="/images/back/xiangzuo.png" alt="向左">
            </button>
            <img src="/images/建档立卡.png" alt="学生提交材料">
            <button type="button" name="button">
              <img src="/images/back/xiangyou1.png" alt="向右">
            </button>
          </span>

            <span class=pbwm-result"">
            <div>
              审核通过：
